<div>
  ...
  <div className="navbar">
    <div className="logo">
      <img src="../img/icon.png" alt style={{width: 50, height: 50, marginRight: 15}} />
      <a className="text" style={{marginTop: 5}}>地震知识科普</a>
    </div>
    <div className="nav-links" style={{marginTop: 10}}>
      <a className="nav-link" href="#" onclick="showContent('content1')">了解地震</a>
      <a className="nav-link" href="#" onclick="showContent('content2')">地震知识</a>
      <a className="nav-link" href="#" onclick="showContent('content3')">地震危害</a>
      <a className="nav-link" href="#" onclick="showContent('content4')">科学避震</a>
      <a className="home-button" href="#" onclick="showContent('content1')" style={{marginTop: '-5px'}}>回到主页</a>
    </div>
  </div>
  {/* 第一页 */}
  <div id="content1" className="content">
    <div className="rectangle-title" style={{marginTop: '10%'}}>
      你了解地震吗？
    </div>
    <div className="rectangle" style={{marginTop: 150}}>
    ...
    <div className="rectangle" style={{marginTop: 40}}>
    ...
    <div className="rectangle" style={{marginTop: 40, marginBottom: 150}}>
      2023年一季度，我国大陆地区共发生4级以上地震22次。
    </div>
  </div>
  {/* 第二页 */}
  <div id="content2" className="content">
    <div className="rectangle-title2" style={{marginTop: '5%'}}>
      地震的基础知识
    </div>
    <div style={{display: 'flex', marginTop: 30}}>
      <img src="../img/dz2.png" style={{width: 500, height: 350, marginTop: 50, marginLeft: 100}} />
      <div className="rectangle2" style={{marginTop: 100, marginRight: 85, marginLeft: 30}}>
        <strong style={{fontSize: 36}}>地震位置</strong><br /><br />
    ...
    <div className="rectangle2" style={{marginTop: 100, width: '85%', marginLeft: 100, marginRight: 0}}>
      <strong style={{fontSize: 36}}>地震成因</strong><br /><br />
    ...
    <div style={{display: 'flex', marginTop: 30}}>
      <img src="../img/22.png" style={{width: 570, height: 650, marginTop: 100, marginLeft: 100, clipPath: 'inset(2% 3% 2% 0.5%)'}} />
      <div className="rectangle2" style={{marginTop: 80, marginRight: 30, marginLeft: 10}}>
        <strong style={{fontSize: 36}}>地震分类</strong><br /><br />
        <strong style={{fontSize: 24, lineHeight: 80}}>根据发生的位置分类</strong><br />
        ...
        <strong style={{fontSize: 24, lineHeight: 80}}>根据震动性质不同分类</strong><br />
        ...
        <strong style={{fontSize: 24, lineHeight: 80}}>按地震形成的原因分类</strong><br />
    ...
    <div style={{display: 'flex', marginTop: 10}}>
      <img src="../img/dz5.jpg" style={{width: 550, height: 600, marginTop: 20, marginLeft: 100}} />
      <div className="rectangle2" style={{marginTop: 10, marginRight: 30, marginLeft: 10}}>
        <strong style={{fontSize: 24, lineHeight: 80}}>根据震源深度分类</strong><br />
        ...
        <strong style={{fontSize: 24, lineHeight: 80}}>按地震的远近分类</strong><br />
        ...
        <strong style={{fontSize: 24, lineHeight: 80}}>按震级大小分类</strong><br />
    ...
    <div style={{display: 'flex', marginTop: 10}}>
      <img src="../img/8.jpg" style={{width: 550, height: 400, marginTop: 100, marginLeft: 100}} />
      <div className="rectangle2" style={{marginTop: 10, marginRight: 30, marginLeft: 10}}>
        <strong style={{fontSize: 24, lineHeight: 80}}>按破坏程度分类</strong><br />
        ...
        <strong style={{fontSize: 24, lineHeight: 80}}>构造地震的分类</strong><br />
    ...
    <div style={{display: 'flex', marginTop: 10}}>
      <div className="rectangle2" style={{marginTop: 100, marginLeft: 100, paddingRight: 10}}>
        <strong style={{fontSize: 36}}>传播方式</strong><br /><br />
      ...
      <img src="../img/7.png" style={{width: 600, height: 300, marginTop: 80, marginLeft: 20, marginRight: 100}} />
    </div>
    <div style={{display: 'flex', marginTop: 10}}>
      <div className="rectangle2" style={{marginTop: 80, marginLeft: 100, paddingRight: 10}}>
      ...
      <img src="../img/9.jpg" style={{width: 800, height: 400, marginTop: 0, marginLeft: 20, marginRight: 100}} />
    </div>
    <div className="rectangle2" style={{marginTop: 100, width: '85%', marginLeft: 100, marginRight: 0}}>
      <strong style={{fontSize: 36}}>震中震源</strong><br /><br />
      <strong style={{lineHeight: 40}}>震源</strong><br />
      地球内部直接产生破裂的地方称为震源，它是一个区域，但研究地震时常把它看成一个点。地面上正对着震源的那一点称为震中，它实际上也是一个区域。<br />
      <strong style={{lineHeight: 40}}>震中</strong><br />
      根据地震仪记录测定的震中称为微观震中，用经纬度表示；根据地震宏观调查所确定的震中称为宏观震中，
      它是极震区（震中附近破坏最严重的地区）的几何中心，也用经纬度表示。由于方法不同，宏观震中与微观震中往往并不重合。
      <br />
      <strong style={{lineHeight: 40}}>震中距</strong><br />
      从震中到地面上任何一点的距离叫做震中距。同一个地震在不同的距离上观察，远近不同，叫法也不一样。<br />
      <strong style={{lineHeight: 40}}>震源深度</strong><br />
      从震源到地面的距离叫做震源深度。<br />
      <strong style={{lineHeight: 40}}>极震区</strong><br />
      震后破坏程度最严重的地区，极震区往往也就是震中所在的地区。<br />
    </div>
    <div style={{display: 'flex', flexDirection: 'row', alignItems: 'start', marginTop: 30, marginBottom: 50}}>
      <div style={{display: 'flex', flexDirection: 'column', marginRight: 20, marginLeft: 100}}>
        <img src="../img/烈度.jpg" style={{width: 600, height: 550, marginTop: 50}} />
        <img src="../img/21.jpg" style={{width: 600, height: 300, marginTop: 10}} />
      </div>
      <div className="rectangle2" style={{marginTop: 80, marginRight: 60, width: '60%', paddingRight: 10}}>
        <strong style={{fontSize: 36}}>震级烈度</strong><br /><br />
        <strong style={{lineHeight: 60}}>震级</strong><br />
        ...
        <strong style={{lineHeight: 60}}>烈度</strong><br />
  ...
  <div id="content3" className="content">
    ...
    <div style={{display: 'flex', marginTop: 30}}>
      <img src="../img/10.jpg" style={{width: 650, height: 450, marginTop: 80, marginLeft: 100}} />
      <div className="rectangle2" style={{marginTop: 120, marginRight: 85, marginLeft: 30}}>
        <strong style={{fontSize: 36}}>直接灾害破坏</strong><br /><br />
    ...
    <div style={{display: 'flex', marginTop: 10}}>
      ...
      <img src="../img/11.jpg" style={{width: 650, height: 450, marginTop: 50, marginLeft: 20, marginRight: 100}} />
    </div>
    <div style={{display: 'flex', marginTop: 30}}>
      <img src="../img/12.jpg" style={{width: 600, height: 420, marginTop: 150, marginLeft: 100}} />
      <div className="rectangle2" style={{marginTop: 80, marginRight: 85, marginLeft: 30}}>
        <strong style={{fontSize: 36}}>次生灾害破坏</strong><br /><br />
        地震次生灾害是直接灾害发生后，破坏了自然或社会原有的平衡或稳定状态，从而引发出的灾害。
        主要有：火灾、水灾、毒气泄漏、瘟疫等。其中火灾是次生灾害中最常见、最严重的。<br /><br />
        <strong style={{color: 'rgb(13, 156, 245)'}}>火灾：</strong>地震火灾多是因房屋倒塌后火源失控引起的。由于震后消防系统受损，社会秩序混乱，火势不易得到有效控制，因而往往酿成大灾。<br />
        <strong style={{color: 'rgb(13, 156, 245)'}}>海啸：</strong>地震时海底地层发生断裂，部分地层出现猛烈上升或下沉，造成从海底到海面的整个水层发生剧烈“抖动”，这就是地震海啸。<br />
        <strong style={{color: 'rgb(13, 156, 245)'}}>瘟疫：</strong>强烈地震发生后，灾区水源、供水系统等遭到破坏或受到污染，灾区生活环境严重恶化，故极易造成疫病流行。社会条件的优劣与灾后疫病是否流行，关系极为密切。<br />
        <strong style={{color: 'rgb(13, 156, 245)'}}>滑坡和崩塌：</strong>这类地震的次生灾害主要发生在山区和塬区，由于地震的强烈振动，使得原已处于不稳定状态的山崖或塬坡发生崩塌或滑坡。这类次生灾害虽然是局部的，但往往是毁灭性的，使整村整户人财全被埋没。<br />
    ...
    <div style={{display: 'flex', marginTop: 30, marginBottom: 50}}>
      <img src="../img/13.jpg" style={{width: 700, height: 480, marginTop: 60, marginLeft: 100}} />
      <div className="rectangle2" style={{marginTop: 80, marginRight: 85, marginLeft: 30}}>
        <strong style={{fontSize: 36}}>破坏程度</strong><br /><br />
  ...
  <div id="content4" className="content">
    ...
    <div className="rectangle-title" style={{fontSize: 36, marginTop: 50, color: 'crimson'}}>
      地震发生时，不论在室内还是室外，保持冷静并采取相关行动，是保护自己的最好方法
    </div>
    <div style={{display: 'flex', marginTop: 30}}>
      <img src="../img/14.gif" alt="Description of the GIF" style={{width: 650, height: 350, marginTop: 120, marginLeft: 100}} />
      <div className="rectangle2" style={{marginTop: 80, marginRight: 85, marginLeft: 30}}>
        <strong style={{fontSize: 36}}>01 因地制宜 正确选择</strong><br /><br />
        <strong style={{lineHeight: 50}}>根据自身环境及自身情况确定避震方法：</strong><br />
        ...
        <strong style={{lineHeight: 50}}>合理利用地震预警信息：</strong><br />
    ...
    <div style={{display: 'flex', marginTop: 30}}>
      <img src="../img/16.jpg" style={{height: 440, marginTop: 80, marginLeft: 100}} />
      <div className="rectangle2" style={{marginTop: 180, marginRight: 85, marginLeft: 30}}>
        <strong style={{fontSize: 36}}>02 行动果断 切记犹豫</strong><br /><br />
        <strong style={{lineHeight: 50}}>或就近躲避，或紧急撤离：</strong><br />
        避震能否成功，就在千钧一发之间，容不得瞻前顾后，犹豫不决。如身处平房时进行避震，更要行动果断，或就近躲避，或紧急撤离，切勿往返。
        有的人跑出危房后又转身回去救人，结果自己也被埋压，记住只有保护好自己，才有可能救助别人。
      </div>
    </div>
    <div style={{display: 'flex', marginTop: 30}}>
      <img src="../img/17.png" style={{width: 630, height: 630, marginTop: 80, marginLeft: 100}} />
      <div className="rectangle2" style={{marginTop: 250, marginRight: 85, marginLeft: 30}}>
        <strong style={{fontSize: 36}}>03 伏而待定 定而急出</strong><br /><br />
        <strong style={{lineHeight: 50}}>伏地、遮挡、手抓牢：</strong><br />
    ...
    <div style={{display: 'flex', marginTop: 30}}>
      <img src="../img/18.png" style={{width: 800, height: 500, marginTop: 80, marginLeft: 100}} />
      <div className="rectangle2" style={{marginTop: 250, marginRight: 85, marginLeft: 30}}>
        <strong style={{fontSize: 36}}>04 听从指挥 不可擅动</strong><br /><br />
        <strong style={{lineHeight: 50}}>公共场所要听从指挥：</strong><br />
        地震后，公共场所应立刻停止教学、生产、交通等活动，采用就近避震原则或听从相关责任人指令，安全有序的撤离。
        在不了解公共场馆内逃生路线的情况下，若是擅自行动、盲目避震，只能招致更大的不幸。
      </div>
    </div>
    <div style={{display: 'flex', marginTop: 30}}>
      <img src="../img/19.jpg" style={{width: 590, height: 350, marginTop: 80, marginLeft: 100}} />
      <div className="rectangle2" style={{marginTop: 100, marginRight: 85, marginLeft: 30, paddingRight: 0}}>
        <strong style={{fontSize: 36}}>05 小开间 近水源</strong><br /><br />
        <strong style={{lineHeight: 50}}>室内较安全的避震地点：</strong><br />
        开间小、有支撑物的房间，如卫生间；内承重墙墙角；震前准备的避震空间；牢固的桌下或床下；低矮、牢固的家具边等。<br />
        <strong style={{lineHeight: 50}}>近水不近火：</strong><br />
        地震避险时尽量靠近水源，不要接近明火。<br />
        地震发生时，房屋建筑破坏时会产生浓烈的烟尘，也可能发生火灾，亦或被困在建筑物中需要等待救援，这些情况都需要有水来湿润衣物或者饮用，因此，避险地点尽量靠近水源。
      </div>
    </div>
    <div style={{display: 'flex', marginTop: 30}}>
      <img src="../img/20.jpg" style={{width: 600, height: 400, marginTop: 80, marginLeft: 100}} />
      <div className="rectangle2" style={{marginTop: 200, marginRight: 85, marginLeft: 30, marginBottom: 150}}>
        <strong style={{fontSize: 36}}>06 跑楼梯 忌电梯 莫跳楼</strong><br /><br />
        <strong style={{lineHeight: 50}}>地震避险时要注意：</strong><br />
        地震发生后，不可乘坐电梯，更不可以跳楼逃生，要选择安全通道迅速撤离。<br />
        如果震时在电梯里，应尽快离开；即使住在一、二层楼，也不要选择跳楼逃生，跳楼不仅会造成骨折等伤害，还会被高处坠落的重物砸伤。
      </div>
    </div>
  </div>
  <footer style={{backgroundColor: 'rgb(7, 20, 37)', height: 300, position: 'relative', width: '100%'}}>
    <div style={{position: 'absolute', bottom: 0, left: 0, width: '100%', borderTop: '1px solid rgb(193, 190, 190)'}}>
      <p style={{color: 'gainsboro', textAlign: 'center'}}>© 2023 by <a href="https://www.whu.edu.cn/" style={{color: 'deepskyblue'}}>Whu Design</a> All Rights Reserved</p>
    </div>
    <div style={{display: 'flex', flexDirection: 'column', marginLeft: 300}}>
      <img src="../img/logo-tmp.png" alt="Your Image Description" style={{width: 100, height: 50, marginTop: 50}} />
      <img src="../img/图片6.png" style={{width: 300, height: 50, marginTop: 5}} />
      <img src="../img/图片5.png" style={{width: 250, height: 50, marginTop: 0}} />
    </div>
  </footer>
</div>
